...
<head>
  ...
  <style>
    @page { size: A4 landscape; margin: 4mm 5mm 5mm; }
    * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    ...
    body { font-size: 8.2px; line-height: 1.35; }
    .header { margin: 0 0 2.5mm; padding: 0 0 2.2mm; border-bottom: 1.5px solid #0f6f99; }
    .kicker { color: #587083; font-size: 7.5px; margin-bottom: 0.8mm; }
    h1 { margin: 0; color: #102a43; font-size: 16px; line-height: 1.15; }
    .meta { margin-top: 1mm; color: #66788a; font-size: 7.3px; display: flex; justify-content: space-between; gap: 3mm; }
    .filters { margin-top: 1.4mm; padding: 1.2mm 1.8mm; border: 1px solid #dbe7ef; border-radius: 1.5mm; background: #f8fbfd; color: #50677a; font-size: 7.3px; line-height: 1.35; }
    table { width: 100%; border-collapse: collapse; table-layout: fixed; }
    thead { display: table-header-group; }
    tr { break-inside: avoid; page-break-inside: avoid; }
    th, td { border: 1px solid #cdd9e3; padding: 1.45mm 1.05mm; vertical-align: middle; text-align: right; line-height: 1.32; word-break: normal; overflow-wrap: anywhere; }
    th { background: #eaf5fb; color: #173a50; font-weight: 900; font-size: 7.4px; white-space: nowrap; }
    tbody tr:nth-child(even) td { background: #f8fbfd; }
    td:first-child, th:first-child { width: 3.5%; text-align: center; }
    th:nth-child(2) { width: 10.5%; }
    th:nth-child(3) { width: 6%; }
    th:nth-child(4) { width: 6%; }
    th:nth-child(5) { width: 20%; }
    th:nth-child(6) { width: 16%; }
    th:nth-child(7) { width: 7%; }
    th:nth-child(8), th:nth-child(9) { width: 11.5%; }
    ...
    .footer { margin-top: 2mm; padding-top: 1.5mm; border-top: 1px solid #dce5ec; display: flex; justify-content: space-between; gap: 3mm; color: #718496; font-size: 6.5px; }
  </style>
</head>
<body>
  <header class="header">
