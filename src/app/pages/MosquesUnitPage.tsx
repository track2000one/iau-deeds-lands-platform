          ...
          <Card className={`${card3d} overflow-hidden`}>
            ...
            <CardContent className="space-y-4 pt-5">
              ...
              <div className="grid gap-3 rounded-2xl border border-slate-200 bg-slate-50/70 p-3 md:grid-cols-[1fr_220px_auto] md:items-center">
                <div className="relative"><Search className="absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-400" /><Input className="h-11 border-sky-300 bg-sky-100/70 pr-10 placeholder:text-slate-500 focus-visible:border-sky-400 focus-visible:ring-sky-300/50" value={quranSearch} onChange={(e) => setQuranSearch(e.target.value)} placeholder="بحث باسم المسجد أو المصلى أو المدينة أو الموقع..." /></div>
