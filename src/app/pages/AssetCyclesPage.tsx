      ...
      <Card className="overflow-hidden rounded-[32px] border border-slate-200/90 bg-white/95 text-slate-900 shadow-[0_20px_55px_rgba(15,23,42,.10)]">
        <CardContent className="p-6 sm:p-8">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <div className="mb-3 flex flex-wrap gap-2"><Badge className="border-sky-200 bg-sky-50 text-sky-800"><History className="ml-1 h-3.5 w-3.5" />سجل تاريخي كامل</Badge><Badge className="border-emerald-200 bg-emerald-50 text-emerald-800"><ShieldCheck className="ml-1 h-3.5 w-3.5" />لا حذف للبيانات القديمة</Badge></div>
