                ...
                <CardContent className="flex h-full flex-col space-y-4 p-4 sm:p-5">
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0">
                      ...
                      <h3 className="mt-1 break-words text-lg font-black text-slate-800">{record.locationName || record.buildingNumber || record.owner?.name || 'مبنى مستأجر'}</h3>
                      <p className="mt-1 text-xs text-muted-foreground">المالك: {record.owner?.name || '-'}</p>
                    </div>
                    <Badge variant="outline" className="shrink-0 border-sky-300 bg-sky-50 text-sky-700">المالك</Badge>
                  </div>
