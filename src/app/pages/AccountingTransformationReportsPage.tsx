...
export const AccountingTransformationReportsPage: React.FC = () => {
  ...
  const handleCycleTemplateVersionUpload = async (file: File | null) => {
    ...
    try {
      ...
      setOfficialExcelMessage(`جارٍ رفع إصدار جديد وتثبيته على الدورة #${selectedCycle.cycleNumber}...`);
      ...
      setOfficialExcelMessage(`تم رفع الإصدار ${result.snapshot.versionNumber} وتثبيته على الدورة #${selectedCycle.cycleNumber}. أصبحت هذه النسخة هي المرجع الرسمي للدورة.`);
