    ...
    <div className="mx-auto w-full max-w-[1780px] space-y-5 pb-8" dir="rtl">
      ...
      <Card className="audit-no-print rounded-[26px]">
        ...
        <CardContent className="grid gap-3 p-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <NativeSelect value={escalationFilter} onChange={(event) => setEscalationFilter(event.target.value as EscalationFilter)}><option value="all">كل حالات المهمة</option><option value="none">بدون تصعيد</option><option value="due_soon">قريب الاستحقاق</option><option value="overdue">متأخر</option><option value="critical">حرج</option></NativeSelect>
      ...
      <Card className="audit-print-card rounded-[26px] border-slate-200 bg-slate-50/70"><CardContent className="flex items-start gap-3 p-4"><FileClock className="mt-1 h-5 w-5 shrink-0 text-slate-600" /><p className="text-[11px] leading-6 text-slate-600">هذا السجل يجمع أحداث Audit Trail المحفوظة في سجلات مؤشرات السيطرة مع أحداث التصعيد النظامية المحسوبة. لا يقدم وظائف تعديل أو حذف للأحداث السابقة. التصدير والطباعة يطبقان الفلاتر الحالية الظاهرة في الصفحة.</p></CardContent></Card>
    </div>
  );
};
