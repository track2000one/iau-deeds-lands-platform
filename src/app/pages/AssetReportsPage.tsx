...
export const AssetReportsPage: React.FC = () => {
  ...
  const printReport = async () => {
    ...
    try {
      ...
      @page{size:A4 landscape;margin:8mm}*{box-sizing:border-box}body{font-family:Tahoma,Arial,sans-serif;color:#172033;margin:0}.header{text-align:center;border-bottom:2px solid #1f4e79;padding-bottom:8px}.header h1{font-size:19px;margin:0}.sub{font-size:9px;color:#64748b;margin-top:3px}.filters{margin:8px 0;padding:7px;border:1px solid #dbe3ec;border-radius:8px;font-size:9px}.summary{display:flex;gap:7px;margin-bottom:8px}.summary div{flex:1;border:1px solid #dbe3ec;border-radius:8px;padding:6px;text-align:center}.summary strong{font-size:14px}table{width:100%;border-collapse:collapse;font-size:8px}th{background:#1f4e79;color:#fff;padding:4px;border:1px solid #dbe3ec}td{padding:4px;border:1px solid #dbe3ec;text-align:center}tbody tr:nth-child(even){background:#f8fafc}thead{display:table-header-group}tr{break-inside:avoid}.footer{margin-top:8px;font-size:7px;color:#64748b;display:flex;justify-content:space-between}</style></head><body>
