...
export const AssetReportsPage: React.FC = () => {
  ...
  return (
    <div id="asset-reports-view" className="mx-auto w-full max-w-[1700px] space-y-5 sm:space-y-6">
